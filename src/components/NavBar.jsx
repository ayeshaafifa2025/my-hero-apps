...
const NavBar = () => {
    return (
        <nav className='mb-10'>
             <div className='flex bg-gray-200 px-5 py-5 justify-between items-center'>
            <div className='flex'>
                <Link to="/">
  <img src={logo} className="w-10 h-10 cursor-pointer" alt="logo" />
</Link>
                <p className="bg-gradient-to-r from-[#632EE3] to-[#9F62F2] font-bold text-3xl text-center bg-clip-text text-transparent">AppNexus</p>
                
            </div>

            <div className=' nav grid grid-cols-1 md:grid-cols-3'>
